-- Script de création de base de données PostgreSQL pour Smook
...
CREATE TABLE IF NOT EXISTS products (
    ...
    image_url TEXT,
    nutriscore VARCHAR(1) CHECK(nutriscore IN ('A', 'B', 'C', 'D', 'E')) DEFAULT NULL,
    ingredients JSONB,
...
(1, 'Latte', 'Grand classique. Chaud ou glacé.', 5.00, 'B', '["Espresso", "Lait"]', FALSE, 'https://images.unsplash.com/photo-1570968915860-54d5c301fa9f'),
